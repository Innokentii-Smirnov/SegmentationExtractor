...
train_data.to_csv(f'{args.language}.word.train.tsv', index=False, sep='\t')
dev_data.to_csv(f'{args.language}.word.dev.tsv', index=False, sep='\t')
test_data.to_csv(f'{args.language}.word.test.gold.tsv', index=False, sep='\t')
test_data[['form', 'pos']].to_csv(f'{args.language}.word.test.tsv', index=False, sep='\t')
